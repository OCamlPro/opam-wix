...
The resulting MSI package generated by opam-wix is a portable installer that can be used on any Windows machine [with](https://wixtoolset.org/) the main disk labeled as "C:". This means you can distribute the generated MSI package to users or deploy it on different machines without restrictions.
